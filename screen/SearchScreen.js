    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.main_container}>
                <Search test="test" handleSearch={this.handleSearchText} handleClickButton={this._searchFilms}/>
                {this.state.searchText !== '' ? <SearchResult textSearched={searchText}/> : null}
                    {this._renderResult()}
